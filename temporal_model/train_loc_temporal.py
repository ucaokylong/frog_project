...
EARLY_STOP_PATIENCE = 10 # Số epoch tối đa chịu đựng nếu loss không giảm
...
def train():
    ...
    epochs_no_improve = 0 # Biến đếm số epoch liên tiếp không cải thiện
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if avg_val < best_val_loss:
            ...
            epochs_no_improve = 0 # Reset bộ đếm về 0 vì đã có kỷ lục mới
            ...
            # Nếu vượt quá sức chịu đựng -> Cắt cầu dao
