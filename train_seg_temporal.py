...
def train():
    ...
    print(f"Bắt đầu train DR-SPAAM Segmentation | Thiết bị: {DEVICE} | T={T_WINDOW}")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if avg_val < best_val_loss:
            ...
            save_path = os.path.join(CHECKPOINT_DIR, "drspaam_seg_best.pth")
            torch.save(model.state_dict(), save_path)
            print(">>> Saved best DR-SPAAM segmentation model.")
